...
export default function Hero () {
  ...
  return (
    <section id="hero" className="hero-grid relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      {/* Scan beam */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <div className="animate-float mb-8">
          <WolfLogo variant="icon" size={140} className="drop-shadow-[0_0_30px_#00D4FF66]" />
        </div>

        {/* Label */}
        <p className="font-mono text-wolf_blue text-xs tracking-[0.4em] mb-4 animate-fade-in" style={{ animationDelay: '0.2s', opacity: 0 }}>
        ...
        {/* Divider */}
        <div className="flex items-center gap-4 mb-6 animate-fade-in" style={{ animationDelay: '0.6s', opacity: 0 }}>
        ...
        {/* School info */}
        <p className="font-mono text-wolf_gray text-xs sm:text-sm tracking-widest mb-8 animate-fade-in" style={{ animationDelay: '0.8s', opacity: 0 }}>
          TESCHA · CHALCO, ESTADO DE MÉXICO · ISC
        </p>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-fade-in" style={{ animationDelay: '1.4s', opacity: 0 }}>
        <span className="font-mono text-wolf_gray/50 text-xs tracking-widest">SCROLL</span>
