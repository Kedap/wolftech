const MEMBERS = [
  {
    ...
    role: "Team Lead & Estrategia",
    color: "#FF6B35",
  },
  {
    name: "Desarrollador de Software",
    role: "Programación & Algoritmos",
    color: "#00D4FF",
  },
  {
    name: "Ingeniero Mecánico",
    role: "Diseño & Manufactura",
    color: "#00FF9F",
  },
  {
  ...
  return (
    <section id="team" className="bg-wolf_black py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Estudiantes de ISC del TESCHA unidos por la pasión por la robótica y
          la tecnología.
        </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {MEMBERS.map(({ name, role, color }, i) => (
            ...
            >
              ...
              <div>
                <p className="font-body font-semibold text-wolf_white text-sm leading-snug mb-1">
                  {name}
                </p>
                <p
